...
<table>
    ...
    for ($i = 0; $i < 5; $i++){
        ...
        echo "<tr><td>";
            ...
            for ($j = 0; $j < sizeof($choices1); $j++){
                echo "<input type='radio' id='".$choices1[$j]."' name='ans".($nums2[$y]+1)."' value='".$choices1[$j],"'><label class='option' for='".$choices1[$j]."'>".$choices1[$j]."</label>";
            }
            echo "</td>";
        echo "</tr>";
        unset($nums[$y]);
    ...
    <button name="submit" type="submit" value="submit" class = "button button1">Calculate</button>
</form>
<br>
...
<?PHP
    if (isset($_GET['submit'],
        ...
        echo "<p>The score is:</p>".$correct."/8";
    }
